...
\newcommand{\githubicon}[1]{\href{#1}{\includegraphics[height=1em]{figures/github.png}}}
\newcommand{\githubicontitle}[1]{\href{#1}{\includegraphics[height=1em]{figures/github-title.png}}}
...
\IEEEcompsocthanksitem G.~Liu, P.~Zhao, Y.~Han, H.~Wang, X.~Liang, W.~Wang, T.~Wu, L.~Li, and Y.~Liu are with Zhejiang University.
\IEEEcompsocthanksitem L.~Liu, Y.~Guo, S.~Ren, H.~Wang, and G.~Xiong are with vivo AI Lab.
\IEEEcompsocthanksitem H.~Xiao, W.~Lin, Y.~Chai, and H.~Li are with CUHK MMLab.
\IEEEcompsocthanksitem The first three authors contribute equally. Liang Liu leads the project. Corresponding authors: Yong Liu (yongliu@iipc.zju.edu.cn), Hongsheng Li (hsli@ee.cuhk.edu.hk).
}
}
...
\markboth{A SUBMISSION TO IEEE TRANSACTIONS ON PATTERN ANALYSIS AND MACHINE INTELLIGENCE}%
...
\input{2_development.tex}
\input{3_frameworks.tex}
\input{4_models.tex}
\input{5_datasets.tex}
\input{6_challenges.tex}
\input{7_conclusion.tex}

\bibliographystyle{IEEEtran}
\bibliography{IEEEabrv,reference}

\input{8_biography.tex}
