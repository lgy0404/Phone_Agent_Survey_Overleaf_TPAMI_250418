...
\author{William Liu$^{1,\dag}$, Liang Liu$^{1,\dag,\ddag}$, Pengxiang Zhao$^{3,\dag}$, Yaxuan Guo$^1$, Han Xiao$^{2}$, Weifeng Lin$^{2}$\\
Yuxiang Chai$^{2}$, Shuai Ren$^1$, Xiaoyu Liang$^3$, Linghao Li$^{1,3}$, Wenhao Wang$^3$\\ 
Tianze Wu$^3$,Yong Liu$^3$, Hao Wang$^1$, Hongsheng Li$^{2,*}$, Guanjing Xiong$^{1,*}$  \\
\normalsize{$^1$~vivo AI Lab\quad$^2$~CUHK MMLab\quad$^3$~Zhejiang University} \\
\small{$^\dag$~Equal Contribution, \quad $^\ddag$~Project Lead, \quad $^*$~Corresponding Authors} \\
\texttt{\small hsli@ee.cuhk.edu.hk}\quad\;\texttt{\small guanjing.xiong@vivo.com} \\
